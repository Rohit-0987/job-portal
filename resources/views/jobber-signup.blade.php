						...
						<div class="colxl-12 col-lg-12 col-md-12">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Candidate Signup</li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div class="container">
					<div class="row align-items-start justify-content-between">
						...
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mfliud">
                            ...
                            @endif
							<form action="jobber-signup-check" method="POST" class="border p-3 rounded">
								@csrf
								<div class="row">
                                ...
                                <div class="form-group">
									...
									<input name="phone" type="number" class="form-control" placeholder="Contact number*">
								</div>
                                ...
                                Already have an account? <a href="company-signin" class="text-success">sign in</a>
							</form>
						</div>
