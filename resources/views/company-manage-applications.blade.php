       ...
       <div class="preloader"></div>
					...
					<div class="dashboard-tlbar d-block mb-5">
						<div class="row">							
							<div class="colxl-12 col-lg-12 col-md-12">
								<h1 class="ft-medium">Manage Job Applications</h1>
								<nav aria-label="breadcrumb">
									<ol class="breadcrumb">
										<li class="breadcrumb-item text-muted"><a href="#">Home</a></li>
										<li class="breadcrumb-item text-muted"><a href="#">Dashboard</a></li>
										<li class="breadcrumb-item"><a href="#" class="theme-cl">Manage Jobs Applications</a></li>
									</ol>
								</nav>
							</div>
						</div>
									...
									<div class="flixors">
										<div class="row align-items-center justify-content-between">
											<div class="col-xl-3 col-lg-4 col-md-5 col-sm-12">
												<h6 class="mb-0 ft-medium fs-sm">{{$data->count()}} Applicants Found</h6>
											</div>
										...
										<div class="dashed-list-full bg-white rounded p-3 mb-3">
											<div class="dashed-list-short d-flex align-items-center">
												<div class="dashed-list-short-first">
													<div class="dashed-avater"><img src="/job-profile-img/" class="img-fluid circle" width="70" alt="" /></div>
												</div>
											...
											<div class="dashed-list-last">
												<div class="text-left">
													<a class="btn gray p-0 ft-medium apply-btn  rounded mr-1">
		...
		<script>
			...
			if(url.includes('filter')) {
				...
				document.getElementById("company-manage-applications").className = " active";  
			}
		</script>
		<!-- ============================================================== -->
		<!-- This page plugins -->
